...
import { AutomatedTradingScheduler } from "./app/schedulers/automated-trading.scheduler";
...
container.bind<AutomatedTradingScheduler>(AutomatedTradingScheduler).toSelf().inSingletonScope();
