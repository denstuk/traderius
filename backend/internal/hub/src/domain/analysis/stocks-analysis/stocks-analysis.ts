...
import { TinkoffV1Converter } from "../../../infra/markets/tinkoff/v1/converter";
import { Predictor } from "../../../infra/predictor";
import { CandleInterval, TinkoffV1Client } from "../../../infra/markets";

@injectable()
export class StocksAnalysis {
	private readonly stocksAnalysisKey: string = "analytics:profitable-stocks";
	...
	async refreshMostProfitable(): Promise<void> {
		const market = new TinkoffV1Client(Configuration.get("TinkoffSharedToken"));
