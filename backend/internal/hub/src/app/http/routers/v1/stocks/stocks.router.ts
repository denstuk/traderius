...
import { CandleInterval, InstrumentIdentifierType, TinkoffV1Client } from "../../../../../infra/markets";
...
router.get("/:ticker", async (req: Request, res: Response) => {
	const marketV1 = new TinkoffV1Client(Configuration.get<string>("TinkoffSharedToken"));
