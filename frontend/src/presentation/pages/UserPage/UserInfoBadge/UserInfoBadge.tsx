			...
			<div className="user-info-badge">
				<div className="badge-columns">
					<div className="badge-column">
						...
						<button className="user-info-badge__button" onClick={() => handleUpdateProfile()}>
							Обновить
						</button>
					</div>
					<div className="badge-column">
